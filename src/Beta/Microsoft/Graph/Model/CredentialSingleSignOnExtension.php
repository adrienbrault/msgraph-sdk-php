...
* 
* CredentialSingleSignOnExtension File
* PHP version 7
*
* @category  Library
...
/**
* CredentialSingleSignOnExtension class
*
* @category  Model
* @package   Microsoft.Graph
* @copyright (c) Microsoft Corporation. All rights reserved.
...
* @link      https://graph.microsoft.com
*/
class CredentialSingleSignOnExtension extends SingleSignOnExtension
{
    /**
    ...
    *
    * @return CredentialSingleSignOnExtension The CredentialSingleSignOnExtension
    */
