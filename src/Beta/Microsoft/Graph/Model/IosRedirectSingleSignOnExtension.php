...
* 
* IosRedirectSingleSignOnExtension File
* PHP version 7
*
* @category  Library
...
/**
* IosRedirectSingleSignOnExtension class
*
* @category  Model
* @package   Microsoft.Graph
* @copyright (c) Microsoft Corporation. All rights reserved.
...
* @link      https://graph.microsoft.com
*/
class IosRedirectSingleSignOnExtension extends IosSingleSignOnExtension
{
    /**
    ...
    *
    * @return IosRedirectSingleSignOnExtension The IosRedirectSingleSignOnExtension
    */
