...
* 
* MacOSCredentialSingleSignOnExtension File
* PHP version 7
*
* @category  Library
...
/**
* MacOSCredentialSingleSignOnExtension class
*
* @category  Model
* @package   Microsoft.Graph
* @copyright (c) Microsoft Corporation. All rights reserved.
...
* @link      https://graph.microsoft.com
*/
class MacOSCredentialSingleSignOnExtension extends MacOSSingleSignOnExtension
{
    /**
    ...
    *
    * @return MacOSCredentialSingleSignOnExtension The MacOSCredentialSingleSignOnExtension
    */
