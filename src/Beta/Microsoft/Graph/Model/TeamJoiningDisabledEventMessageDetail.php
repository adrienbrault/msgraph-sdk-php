...
* 
* TeamJoiningDisabledEventMessageDetail File
* PHP version 7
*
* @category  Library
...
/**
* TeamJoiningDisabledEventMessageDetail class
*
* @category  Model
* @package   Microsoft.Graph
* @copyright (c) Microsoft Corporation. All rights reserved.
...
* @link      https://graph.microsoft.com
*/
class TeamJoiningDisabledEventMessageDetail extends EventMessageDetail
{
    /**
    ...
    *
    * @return TeamJoiningDisabledEventMessageDetail The TeamJoiningDisabledEventMessageDetail
    */
