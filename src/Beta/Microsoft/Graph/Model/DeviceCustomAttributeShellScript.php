...
class DeviceCustomAttributeShellScript extends Entity
{
    ...
    *
    * @return string|null The customAttributeName
    */
    ...
    *
    * @return DeviceCustomAttributeValueType|null The customAttributeType
    */
    public function getCustomAttributeType()
    {
        if (array_key_exists("customAttributeType", $this->_propDict) && !is_null($this->_propDict["customAttributeType"])) {
