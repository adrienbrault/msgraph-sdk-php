...
class Message extends OutlookItem
{
    ...
    *
    * @return MentionsPreview|null The mentionsPreview
    */
    public function getMentionsPreview()
    {
        if (array_key_exists("mentionsPreview", $this->_propDict) && !is_null($this->_propDict["mentionsPreview"])) {
    ...
    *
    * @return bool|null The unsubscribeEnabled
    */
