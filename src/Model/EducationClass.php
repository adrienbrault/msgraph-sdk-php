...
class EducationClass extends Entity
{
    ...
    *
    * @return string|null The classCode
    */
    ...
    */
    ...
    {
        if (array_key_exists("course", $this->_propDict) && !is_null($this->_propDict["course"])) {
    ...
    *
    * @return string|null The externalName
    */
    ...
    */
    ...
    {
        if (array_key_exists("term", $this->_propDict) && !is_null($this->_propDict["term"])) {
    ...
    */
     ...
     *
     * @return EducationCategory[]|null The assignmentCategories
     */
    ...
    */
    ...
    {
        if (array_key_exists("assignmentDefaults", $this->_propDict) && !is_null($this->_propDict["assignmentDefaults"])) {
            if (is_a($this->_propDict["assignmentDefaults"], "\Microsoft\Graph\Model\EducationAssignmentDefaults")) {
    ...
    */
    ...
    {
        if (array_key_exists("assignmentSettings", $this->_propDict) && !is_null($this->_propDict["assignmentSettings"])) {
            if (is_a($this->_propDict["assignmentSettings"], "\Microsoft\Graph\Model\EducationAssignmentSettings")) {
    ...
    * All users in the class. Nullable.
     *
     * @return EducationUser[]|null The members
     */
    ...
    * All teachers in the class. Nullable.
     *
     * @return EducationUser[]|null The teachers
     */
