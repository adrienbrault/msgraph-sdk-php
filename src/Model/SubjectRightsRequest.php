...
class SubjectRightsRequest extends Entity
{
    ...
    */
    public function getAssignedTo()
    {
        if (array_key_exists("assignedTo", $this->_propDict) && !is_null($this->_propDict["assignedTo"])) {
            if (is_a($this->_propDict["assignedTo"], "\Microsoft\Graph\Model\Identity")) {
    ...
    */
    ...
    {
        if (array_key_exists("dataSubject", $this->_propDict) && !is_null($this->_propDict["dataSubject"])) {
            if (is_a($this->_propDict["dataSubject"], "\Microsoft\Graph\Model\DataSubject")) {
    ...
    */
    ...
    {
        if (array_key_exists("dataSubjectType", $this->_propDict) && !is_null($this->_propDict["dataSubjectType"])) {
            if (is_a($this->_propDict["dataSubjectType"], "\Microsoft\Graph\Model\DataSubjectType")) {
    ...
    * Collection of history change events.
     *
     * @return SubjectRightsRequestHistory[]|null The history
     */
    ...
    */
    ...
    {
        if (array_key_exists("insight", $this->_propDict) && !is_null($this->_propDict["insight"])) {
            if (is_a($this->_propDict["insight"], "\Microsoft\Graph\Model\SubjectRightsRequestDetail")) {
    ...
    */
    ...
    {
        if (array_key_exists("internalDueDateTime", $this->_propDict) && !is_null($this->_propDict["internalDueDateTime"])) {
            if (is_a($this->_propDict["internalDueDateTime"], "\DateTime")) {
    ...
    * Information about the different stages for the request.
     *
     * @return SubjectRightsRequestStageDetail[]|null The stages
     */
    ...
    */
    public function getStatus()
    {
        if (array_key_exists("status", $this->_propDict) && !is_null($this->_propDict["status"])) {
            if (is_a($this->_propDict["status"], "\Microsoft\Graph\Model\SubjectRightsRequestStatus")) {
    ...
    */
    public function getType()
    {
        if (array_key_exists("type", $this->_propDict) && !is_null($this->_propDict["type"])) {
            if (is_a($this->_propDict["type"], "\Microsoft\Graph\Model\SubjectRightsRequestType")) {
    ...
    * List of notes associcated with the request.
     *
     * @return AuthoredNote[]|null The notes
     */
